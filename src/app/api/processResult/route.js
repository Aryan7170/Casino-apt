...
const ADMIN_PRIVATE_KEY =
  "0x4cca25dc4eea8925492e6e25cfb9824347d2e5eebe67e788aab186f0233a43d2";
  ...
  try {
    ...
    if (
      ...
      return NextResponse.json(
        { error: "Missing roundId or multiplier" },
        { status: 400 }
      );
    }
    ...
    console.log(
      "Do addresses match?",
      wallet.address.toLowerCase() === gameOperator.toLowerCase()
    );
