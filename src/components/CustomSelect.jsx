      ...
      <div className="relative">
        ...
        <div className="magic-gradient p-0.5 rounded">
          <select
            ...
            value={value}
            onChange={onChange}
            className="w-full rounded py-3 pl-11 pr-4 bg-[#09011C] text-white focus:outline-none focus:ring-2 focus:ring-[#5A00F2] transition-shadow cursor-pointer appearance-none"
            style={{
              backgroundImage:
