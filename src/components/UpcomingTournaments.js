      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {tournaments.map((tournament) => (
            <div
              key={tournament.id}
              className="p-[1px] bg-gradient-to-r from-red-magic to-blue-magic rounded-xl"
            >
                ...
                <div className="p-4 border-t border-white/5">
                  ...
                  <GradientBorderButton
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      console.log(
                        `🎯 Register for tournament: ${tournament.name}`
                      );
                      // For now just show alert, could be expanded to open registration modal
                      alert(
                        `Registration for "${
                          tournament.name
                        }" is coming soon! Tournament starts in ${formatTimeRemaining(
                          tournament.startsIn
                        )}.`
                      );
                    }}
