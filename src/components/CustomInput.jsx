    ...
    <div className={`flex flex-col gap-2 ${className}`}>
      ...
      <div className="relative">
        ...
        <div className="magic-gradient p-0.5 rounded">
          {type === "boolean" ? (
            <div className="w-full rounded py-3 pl-11 pr-4 bg-[#09011C] flex items-center justify-between">
              <span className="text-white font-medium text-sm mr-4 truncate">
                Enable AI Assistant
              </span>
              <label className="relative inline-flex items-center cursor-pointer flex-shrink-0">
                ...
                />
                <div className="w-11 h-6 bg-gray-700 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-[#5A00F2] rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-purple-600"></div>
              </label>
            </div>
          ) : type === "multiSelect" ? (
            <select
              ...
              onChange={onChange}
              multiple
              className="w-full rounded py-3 pl-11 pr-4 bg-[#09011C] text-white focus:outline-none focus:ring-2 focus:ring-[#5A00F2] transition-shadow cursor-pointer"
            >
            ...
            <input
              ...
              className={`w-full rounded py-3 pl-11 ${
                name === "betAmount" || name.includes("stop")
                  ? "pr-16"
                  : "pr-4"
              } bg-[#09011C] text-white focus:outline-none focus:ring-2 focus:ring-[#5A00F2] transition-shadow cursor-pointer`}
            />
          )}
        </div>
        {(name === "betAmount" || name.includes("stop")) && (
          <div className="absolute right-4 top-1/2 transform -translate-y-1/2 text-xs text-white/50 pointer-events-none bg-[#09011C]/80 px-2 py-1 rounded">
            APTC
          </div>
        )}
      </div>
