...
export const useMines = () => {
  ...
  useEffect(() => {
    if (playerGame) {
      ...
      setGameState({
        ...
        betAmount: betAmount ? ethers.formatEther(betAmount) : 0,
        mines: Number(mines),
  ...
  return {
    ...
    // Contract data
    minBet: minBet ? ethers.formatEther(minBet) : "0",
    maxBet: maxBet ? ethers.formatEther(maxBet) : "0",
    maxMines: Number(maxMines) || 24,
    gridSize: Number(gridSize) || 25,
    tokenBalance: tokenBalance ? ethers.formatEther(tokenBalance) : "0",
    tokenAllowance: tokenAllowance ? ethers.formatEther(tokenAllowance) : "0",
